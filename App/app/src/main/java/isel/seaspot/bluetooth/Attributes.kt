...
data class Characteristic(
    ...
    constructor(uuid: UUID, fullUUID: UUID, value: ByteArray, isWritable: Boolean = false) :
            this(AssignedNumbersCharacteristics.uuidToEnum(uuid) ?: AssignedNumbersCharacteristics.Unknown, fullUUID.toString(), value, isWritable)
...
fun doesItContainField(fullInt: Int, field: CharacteristicField) : Boolean {
    if (field.code!=1){
        ...
        if(!isPotencyOf2) throw IllegalArgumentException("The value of $field isn't a power of 2, meaning this propertyCode is probably incorrect")
    }
